package com.bank.bian.cardauthorization.model;
...
/**
 * The BIAN control record for this service domain: "Card Authorization Procedure".
 *
 ...
 * to its asset type (Card Authorization). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Card Authorization Procedure";
